...
import com.app.messaging.consumer.ActorConsumer;
...
public class ActorMovieServiceImpl implements ActorMovieService {
    ...
    @Autowired
    public ActorMovieServiceImpl(ActorMovieRepository actorMovieRepository, ActorConsumer actorConsumer) {
    ...
    public Mono<Void> saveActorMovie(ActorMovieDTO actorMovieDTO) {
        return Mono.just(actorConsumer.receive())
            .flatMapMany(movie -> {
