...
@Component
public class ActorMovieConsumer {

    private static final Logger log = LogManager.getLogger(ActorMovieConsumer.class);
    ...
    @KafkaListener(topics = "movie-data", groupId = "actor-group",containerFactory = "actorKafkaListenerContainerFactory")
