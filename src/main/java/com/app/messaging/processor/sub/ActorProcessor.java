...
@Component("ActorProcessor")
public class ActorProcessor implements Processor<Movie> {

    private static final Logger log = LogManager.getLogger(ActorProcessor.class);
