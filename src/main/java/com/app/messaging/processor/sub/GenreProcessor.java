...
@Component("GenreProcessor")
public class GenreProcessor implements Processor<Movie> {

    private static final Logger log = LogManager.getLogger(GenreProcessor.class);
